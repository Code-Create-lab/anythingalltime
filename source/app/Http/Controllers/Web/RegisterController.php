...
class RegisterController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (! ($checkUserReg) || $checkUserReg->is_verified == 0) {
            $message = ['status' => '0', 'message' => 'Phone not registered', 'data' => []];
        ...
        if ($checkUser) {
            ...
            if ($checkUser->is_verified == 0) {
                ...
                $message = ['status' => '2', 'message' => 'Verify Phone', 'data' => [$checkUser1]];
                ...
                $message = ['status' => '1', 'message' => 'login successfully', 'data' => [$checkUser1]];
    ...
    public function myprofile(Request $request)
    {
        ...
        if ($user) {
            $message = ['status' => '1', 'message' => 'User Profile', 'data' => $user];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'User not found', 'data' => []];
    ...
    public function forgotPassword(Request $request)
    {
        ...
        if ($checkUser) {
            ...
            if ($updateOtp) {
                ...
                $message = ['status' => '0', 'message' => 'Something wrong', 'data' => []];

                return $message;
            }
        } else {
            $message = ['status' => '0', 'message' => 'User not registered', 'data' => []];
    ...
    public function verifyOtp(Request $request)
    {
        ...
        if ($getUser) {
            ...
            if ($otp == $getotp) {
                $message = ['status' => 1, 'message' => 'Otp Matched Successfully'];
    ...
    public function profile_edit(Request $request)
    {
        ...
        if ($checkUser && $checkUser->is_verified == 1) {
            ...
            if ($insertUser) {
                ...
                $message = ['status' => '1', 'message' => 'Profile Updated', 'data' => $Userdetails];
