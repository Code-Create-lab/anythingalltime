...
class SearchController extends Controller
{
    public function search(Request $request)
    {
        ...
        if ($ean_code == null) {
            $message = ['status' => '0', 'message' => 'Not able to scan any barcode'];
    ...
    public function trensearchproducts(Request $request)
    {
        ...
        if (count($prodsssss) > 0) {
            ...
            $message = ['status' => '1', 'message' => 'Products found', 'data' => $prodsssss];
    ...
    public function recentsearch(Request $request)
    {
        ...
        if (count($prodsssss) > 0) {
            ...
            $message = ['status' => '1', 'message' => 'Recent Search found', 'data' => $prodsssss];
