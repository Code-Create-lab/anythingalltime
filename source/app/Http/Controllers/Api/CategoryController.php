...
class CategoryController extends Controller
{
    public function product_images(Request $request)
    {
        ...
        if (count($images) > 0) {
            $message = ['status' => '1', 'message' => 'Product Images', 'data' => $images];
            ...
            if (count($images) > 0) {
                ...
                $message = ['status' => '0', 'message' => 'no images found', 'data' => $images];
        ...
        if ($nearbystore) {
            ...
            if ($nearbystore->del_range >= $nearbystore->distance) {
                if ($nearbystore->store_status == 1) {
                    $message = ['status' => '1', 'message' => 'Store Found at your location', 'data' => $nearbystore];

                    return $message;
                } else {
                    $message = ['status' => '2', 'message' => 'Store Is Closed', 'data' => $nearbystore];
                ...
                $message = ['status' => '0', 'message' => 'We are not delivering your area. we service in '.$city_name.' only'];
    ...
    public function oneapi(Request $request)
    {
        ...
        if ($new != null) {
            ...
            foreach ($new as $prods) {
                ...
                $k++;
                $l++;
                $app = is_string($prods->product_id) ? json_decode($prods->product_id) : $prods->product_id;
                $apps = [$app];
                $images = DB::table('product_images')
                    ->select('image')
        ...
        try {
            $spots = DB::table('spotlight')
                ...
                ->orderByRaw(DB::getDriverName() === 'sqlite' ? 'RANDOM()' : 'RAND()')
                ->where('product.hide', 0)
                ->where('store_products.price', '!=', null)
                ->orderBy('product.product_name', $filter)
                ->orderBy('store_products.p_id', $filter3)
            ...
            $spots = collect(); // Empty collection if table doesn't exist
        }
        ...
        $cats = DB::table('categories')
            ...
            ->join('product_varient', 'product.product_id', '=', 'product_varient.product_id')
            ->join('store_products', 'product_varient.varient_id', '=', 'store_products.varient_id')
            ->select('categories.title', 'categories.cat_id', 'categories.description')
            ->groupBy('categories.title', 'categories.cat_id', 'categories.description')
            ->where('store_products.store_id', $store_id)
            ->where('categories.status', 2)
            ->get();

        $catt = $cats->unique('cat_id');

        $cat = null;
        foreach ($catt as $storee) {
            $prodddu = DB::table('store_products')
                ->join('product_varient', 'store_products.varient_id', '=', 'product_varient.varient_id')
                ->join('product', 'product_varient.product_id', '=', 'product.product_id')
                ->Leftjoin('store_orders', 'product_varient.varient_id', '=', 'store_orders.varient_id')
                ->Leftjoin('orders', 'store_orders.order_cart_id', '=', 'orders.cart_id')
                ...
                ->where('product.hide', 0)
                ->where('store_products.store_id', $store_id)
                ->where('product.cat_id', $storee->cat_id)
                ->where('store_products.price', '!=', null)
                ->limit(6)
                ->get();

            $prodsd = $prodddu->unique('product_id');
            ...
            $cat[] = ['cat_id' => $storee->cat_id, 'cat_title' => $storee->title, 'description' => $storee->description, 'products' => $prodddu];
        }
        ...
        $message = ['status' => '1', 'message' => 'Homepage data', 'banner' => $banner, 'second_banner' => $secbanner, 'top_cat' => $topsix, 'recentselling' => $recent_selling, 'topselling' => $top_selling, 'dealproduct' => $deal, 'whatsnew' => $whatsnew, 'spotlight' => $spotlight, 'category' => $cat];
    ...
    public function cate(Request $request)
    {
        ...
        if ($cat != null) {
            ...
            foreach ($cat as $cats) {
                ...
                $app = is_string($cats->cat_id) ? json_decode($cats->cat_id) : $cats->cat_id;
                $apps = [$app];
            ...
            $message = ['status' => '1', 'message' => 'data found', 'data' => $cat];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'Category not found'];
    ...
    public function top_cat_prduct(Request $request)
    {
        ...
        if ($topsix != null) {
            ...
            $message = ['status' => '1', 'message' => 'data found', 'data' => $topsix];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'Nothing in Top Categories'];
    ...
    public function catego(Request $request)
    {
        ...
        if (count($cat) > 0) {
            ...
            $message = ['status' => '1', 'message' => 'data found', 'data' => $catss];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'data not found'];
    ...
    public function cat_product(Request $request)
    {
        ...
        if ($price1) {
            ...
            $message = ['status' => '0', 'message' => 'Products not found'];
        ...
        if ($prod != null) {
            ...
            $message = ['status' => '1', 'message' => 'Products found', 'data' => $prod];
    ...
    public function varient(Request $request)
    {
        ...
        if (count($varient) > 0) {
            $message = ['status' => '1', 'message' => 'varients', 'data' => $varient];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'Varients not found'];
    ...
    public function dealproduct(Request $request)
    {
        ...
        if ($deal_products != null) {
            ...
            $message = ['status' => '1', 'message' => 'Products found', 'data' => $deal_products];
    ...
    public function top_cat(Request $request)
    {
        ...
        if ($topsix != null) {
            $message = ['status' => '1', 'message' => 'Top Categories', 'data' => $topsix];
    ...
    public function banner_var(Request $request)
    {
        ...
        $prod = DB::table('store_products')
            ...
            ->first();
        if (! $prod) {
            $message = ['status' => '0', 'message' => 'Product not found'];
        ...
        if ($prod) {
            ...
            $data = ['detail' => $prod, 'similar_product' => $prod1];

            $message = ['status' => '1', 'message' => 'Products Detail', 'data' => $data];
