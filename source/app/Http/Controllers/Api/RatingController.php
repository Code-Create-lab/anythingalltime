...
class RatingController extends Controller
{
    public function review_on_delivery(Request $request)
    {
        ...
        if ($check) {
            ...
            if ($review) {
                $message = ['status' => '1', 'message' => 'reviewed successfully'];
            ...
            $message = ['status' => '0', 'message' => 'Please Wait for Order Completion'];
    ...
    public function check_for_rating(Request $request)
    {
        ...
        if ($check && ! $check2) {
            $message = ['status' => '1', 'message' => 'User Can Review'];

            return $message;
        } elseif ($check && $check2) {
            $message = ['status' => '2', 'message' => 'User Already Reviewed'];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'User Cannot Reviewed'];
    ...
    public function get_product_rating(Request $request)
    {
        ...
        if ($getrating) {
            ...
            $message = ['status' => '1', 'message' => 'Product Rating', 'data' => $ratingssss];
