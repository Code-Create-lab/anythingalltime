...
class OrderController extends Controller
{
    ...
    public function razorpay_order(Request $request)
    {
        ...
        $order = $api->order->create(['amount' => $db->rem_price * 100, 'currency' => 'INR', 'notes' => ['userId' => $db->id, 'userName' => $db->name, 'userEmail' => $db->email, 'userContact' => $db->user_phone, 'cartId' => $db->cart_id, 'orderDate' => $db->order_date]]);
        $data = ['id' => $order->id,
            'entity' => 'order',
            'amount' => $order->amount,
            'amount_paid' => 0,
    ...
    public function checkout(Request $request)
    {
        ...
        if ($payment_method == 'COD' || $payment_method == 'cod') {
            ...
            $message = ['status' => '1', 'message' => 'Order Placed successfully', 'data' => $orderr1];
            ...
            if ($payment_status == 'success') {
                ...
                $message = ['status' => '0', 'message' => 'Payment Failed'];
    ...
    public function cancel_for(Request $request)
    {
        ...
        if ($cancelfor) {
            $message = ['status' => '1', 'message' => 'Cancelling reason list', 'data' => $cancelfor];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'no list found', 'data' => []];
    ...
    public function delete_order(Request $request)
    {
        ...
        if (! $user) {
            $message = ['status' => '0', 'message' => 'Order not found'];
        ...
        if ($user->order_status == 'Completed' || $user->order_status == 'completed' || $user->order_status == 'COMPLETED') {
            ...
            $message = ['status' => '0', 'message' => 'You can not cancel this order as this order has been completed'];
            ...
            if ($reason == null) {
                $message = ['status' => '0', 'message' => 'Select a Cancelling Reason First'];
            ...
            if ($order) {
                ...
                $q = DB::table('users')
                    ...
                    ->where('id', $user_id)
                    ->first();
                $user_email = $q ? $q->email : null;
                $device_id = $q ? $q->device_id : null;
                $user_name = $q ? $q->name : null;
                $email_status = $email ? $email->email : null;
                if ($email_status == 1) {
                ...
                $message = ['status' => '1', 'message' => 'order cancelled', 'data' => $order];
    ...
    public function whatsnew(Request $request)
    {
        ...
        if ($new != null) {
            ...
            $message = ['status' => '1', 'message' => 'New in Store', 'data' => $new];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'nothing in new'];
    ...
    public function can_orders(Request $request)
    {
        ...
        if (count($ongoing) > 0) {
            ...
            $message = ['status' => '1', 'message' => 'Cancelled orders', 'data' => $data];

            return $message;
        } else {
            $message = ['status' => '1', 'message' => 'No Orders Cancelled Yet', 'data' => []];
    ...
    public function top_selling(Request $request)
    {
        ...
        if ($topselling != null) {
            ...
            $message = ['status' => '1', 'message' => 'top selling products', 'data' => $topselling];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'nothing in top'];
    ...
    public function spotlight(Request $request)
    {
        ...
        if ($recentselling != null) {
            ...
            $message = ['status' => '1', 'message' => 'spotlight products', 'data' => $recentselling];

            return $message;
        } else {
            $message = ['status' => '0', 'message' => 'nothing in recentselling'];
    ...
    public function recentselling(Request $request)
    {
        ...
        if ($recentselling != null) {
            ...
            $message = ['status' => '1', 'message' => 'recent selling products', 'data' => $recentselling];
