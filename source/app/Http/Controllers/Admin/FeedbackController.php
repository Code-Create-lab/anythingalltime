...
class FeedbackController extends Controller
{
    ...
    public function user_feedback(Request $request)
    {
        ...
        return view('admin.feedback.user_feedback', compact('title', 'admin', 'logo', 'admin', 'feedback', 'url_aws'));
    }
    ...
    public function store_feedback(Request $request)
    {
        ...
        return view('admin.feedback.store_feedback', compact('title', 'admin', 'logo', 'admin', 'feedback', 'url_aws'));
    }
    ...
    public function driver_feedback(Request $request)
    {
        ...
        return view('admin.feedback.driver_feedback', compact('title', 'admin', 'logo', 'admin', 'feedback', 'url_aws'));
    }
}
