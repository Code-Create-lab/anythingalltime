...
class SalesreportController extends Controller
{
    ...
    public function sales_today(Request $request)
    {
        ...
        return view('admin.salesreport.todaysales', compact('title', 'logo', 'ord', 'admin', 'admin_email', 'details', 'url_aws'));
    }
    ...
    public function orders(Request $request)
    {
        ...
        return view('admin.salesreport.datewise', compact('title', 'logo', 'ord', 'admin', 'admin_email', 'details', 'url_aws'));
    }
}
