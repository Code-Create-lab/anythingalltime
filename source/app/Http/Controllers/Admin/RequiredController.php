...
class RequiredController extends Controller
{
    ...
    public function storeclist(Request $request)
    {
        ...
        return view('admin.itemsalesreport.stores', compact('title', 'city', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function reqfortoday(Request $request)
    {
        ...
        return view('admin.itemsalesreport.stocktoday', compact('store_id', 'admin', 'admin_email', 'title', 'logo', 'ord', 'det', 'url_aws'));
    }
    ...
    public function ad_reqforthirty(Request $request)
    {
        ...
        return view('admin.itemsalesreport.stockthirty', compact('admin_email', 'admin', 'title', 'logo', 'ord', 'det', 'url_aws'));
    }
    ...
    public function reqdaywise(Request $request)
    {
        ...
        if ($next_date != $date) {
            ...
            return view('admin.itemsalesreport.stockdatewise', compact('store_id', 'admin', 'admin_email', 'title', 'logo', 'ord', 'det', 'url_aws'));
        } else {
            $title = 'Required Item List '.$date;
            $ord = DB::table('store_orders')
                ->join('orders', 'store_orders.order_cart_id', '=', 'orders.cart_id')
