...
class ReasonController extends Controller
{
    ...
    public function can_res_list(Request $request)
    {
        ...
        return view('admin.reasons.reasonlist', compact('title', 'reason', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function can_res_add(Request $request)
    {
        ...
        return view('admin.reasons.reasonadd', compact('title', 'reasons', 'admin', 'logo', 'url_aws'));
    }
    ...
    public function can_res_edit(Request $request)
    {
        ...
        return view('admin.reasons.reasonedit', compact('title', 'reason', 'admin', 'logo', 'url_aws'));
    }
