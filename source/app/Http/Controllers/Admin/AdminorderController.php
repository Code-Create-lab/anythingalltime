...
class AdminorderController extends Controller
{
    ...
    public function admin_com_orders(Request $request)
    {
        ...
        // Get cart IDs from paginated orders to limit details query
        $cartIds = $ord->pluck('cart_id')->toArray();

        $details = DB::table('orders')
            ->join('store_orders', 'orders.cart_id', '=', 'store_orders.order_cart_id')
            ->where('store_orders.store_approval', 1)
            ->whereIn('orders.cart_id', $cartIds)
            ->get()
            ->groupBy('cart_id');
    ...
    public function admin_can_orders(Request $request)
    {
        ...
        return view('admin.all_orders.cancelled', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
    ...
    public function admin_pen_orders(Request $request)
    {
        ...
        return view('admin.all_orders.pending', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
    ...
    public function store_cancelled(Request $request)
    {
        ...
        // Pre-fetch nearby stores by society to avoid n+1 queries in the view
        $societyIds = $ord->pluck('society_id')->unique()->toArray();
        $storesBySociety = DB::table('store')
            ->join('service_area', 'store.id', '=', 'service_area.store_id')
            ->select('store.id', 'store.store_name', 'service_area.society_id')
            ->where('admin_approval', 1)
            ->where('store_status', 1)
            ->whereIn('service_area.society_id', $societyIds)
            ->get()
            ->groupBy('society_id');
        ...
        return view('admin.store.cancel_orders', compact('title', 'logo', 'ord', 'details', 'admin', 'nearbystores', 'storesBySociety', 'url_aws'));
    }
    ...
    public function missed_orders(Request $request)
    {
        ...
        return view('admin.all_orders.missed', compact('title', 'logo', 'ord', 'details', 'admin', 'delivery', 'url_aws'));
    }
    ...
    public function admin_on_orders(Request $request)
    {
        ...
        return view('admin.all_orders.ongoing', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
    ...
    public function admin_all_orders(Request $request)
    {
        ...
        return view('admin.all_orders.all_orders', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
    ...
    public function admin_out_orders(Request $request)
    {
        ...
        return view('admin.all_orders.out_orders', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
    ...
    public function admin_failed_orders(Request $request)
    {
        ...
        return view('admin.all_orders.failed', compact('title', 'logo', 'ord', 'details', 'admin', 'url_aws'));
    }
}
