...
class TaxreportController extends Controller
{
    ...
    public function taxreport(Request $request)
    {
        ...
        return view('admin.itemsalesreport.taxtoday', compact('admin', 'admin_email', 'title', 'logo', 'ordd', 'url_aws'));
    }
    ...
    public function taxdatewise(Request $request)
    {
        ...
        return view('admin.itemsalesreport.taxdatewise', compact('admin', 'admin_email', 'title', 'logo', 'ordd', 'url_aws'));
    }
}
