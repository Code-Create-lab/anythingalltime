...
{
    use ImageStoragePicker, SendMail;
    ...
    public function finance(Request $request)
    {
        ...
        return view('admin.store.finance', compact('title', 'admin', 'logo', 'total_earnings', 'url_aws'));
    }
    ...
    public function boy_incentive(Request $request)
    {
        ...
        return view('admin.d_boy.finance', compact('title', 'admin', 'logo', 'total_earnings', 'url_aws'));
    }
