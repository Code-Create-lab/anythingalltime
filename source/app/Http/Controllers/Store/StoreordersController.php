...
class StoreordersController extends Controller
{
    ...
    public function store_can_orders(Request $request)
    {
        ...
        return view('store.all_orders.cancelled', compact('title', 'logo', 'ord', 'details', 'store', 'url_aws'));
    }
    ...
    public function store_pen_orders(Request $request)
    {
        ...
        return view('store.all_orders.pending', compact('title', 'logo', 'ord', 'details', 'store', 'url_aws'));
    }
    ...
    public function store_dboy_orders(Request $request)
    {
        ...
        return view('store.d_boy.orders', compact('title', 'logo', 'ord', 'dboy', 'details', 'store', 'nearbydboy', 'url_aws'));
    }
    ...
    public function missed_orders(Request $request)
    {
        ...
        return view('store.all_orders.missed', compact('title', 'logo', 'ord', 'details', 'store', 'delivery', 'url_aws'));
    }
    ...
    public function store_on_orders(Request $request)
    {
        ...
        return view('store.all_orders.ongoing', compact('title', 'logo', 'ord', 'details', 'store', 'url_aws'));
    }
    ...
    public function store_out_orders(Request $request)
    {
        ...
        return view('store.all_orders.out_orders', compact('title', 'logo', 'ord', 'details', 'store', 'url_aws'));
    }
    ...
    public function store_failed_orders(Request $request)
    {
        ...
        return view('store.all_orders.failed', compact('title', 'logo', 'ord', 'details', 'store', 'url_aws'));
    }
}
