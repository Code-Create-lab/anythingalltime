            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <form class="forms-sample" action="{{route('cityad-dboynew')}}" method="post" enctype="multipart/form-data">
                      {{csrf_field()}}
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                       <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="id_number" class="form-control" value="{{old('id_no')}}" required>
                        </div>
                      </div>
                     <div class="col-md-6">
                     ...
                     @if($mapset->mapbox == 0 && $mapset->google_map == 0)
                      <div class="row">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text" name="boy_loc" id="boy_loc" class="form-control" required>
                        </div>
                          </div>
                            <div class="col-md-6">
                           <div class="form-group">
                            <label for="lat"> {{ __('keywords.Latitude')}} </label>
                            <input type="text" name="lat" id="lat" class="form-control" placeholder="e.g. 12.9716">
                        </div>
                          </div>
                            <div class="col-md-6">
                           <div class="form-group">
                            <label for="lng"> {{ __('keywords.Longitude')}} </label>
                            <input type="text" name="lng" id="lng" class="form-control" placeholder="e.g. 77.5946">
                        </div>
                          </div>
                      </div>
                      @endif
