                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                ...
                                <select class="form-control form-control-sm img" name="coupon_type" id="coupon_type">
                                  <option value="regular" @if($coupon->typecoupon=='default') selected @endif>{{ __('keywords.Reg_Coupon')}}</option>
                                  <option value="firstsale" @if($coupon->typecoupon=='forder') selected @endif>{{ __('keywords.Fst_Coupon')}}</option>
                                </select>
                              </div>
                            </div>
                            <div class="col-md-6">
