    ...
    <tbody>
        ...
        <tr>
            <td class="text-center">{{$i}}</td>
             <td><img src="{{rtrim(url('/'), '/') . '/' . ltrim($products->product_image, '/')}}" alt="{{$products->product_name}}" style="width:50px;height:50px; border-radius:50%;" onerror="this.src='{{asset('images/default-product.png')}}'"></td>
