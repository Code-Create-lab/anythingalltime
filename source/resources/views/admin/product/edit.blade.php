            ...
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="row">
                    ...
                    <img src="{{rtrim($url_aws, '/') . '/' . ltrim($product->product_image, '/')}}" alt="image" name="old_image" style="width:100px;height:100px; border-radius:50%;" onerror="this.src='{{asset('images/default-product.png')}}'">
                     <div class="row">
                      <div class="col-md-12">
                        <div class="form">
                    ...
                    <div class="row">                  
                         ...
                         @foreach($images as $im)
                              <img src="{{rtrim($url_aws, '/') . '/' . ltrim($im->image, '/')}}" alt="image" style="width:50px;height:50px; border-radius:50%;border:2px solid black;float: left;" onerror="this.src='{{asset('images/default-product.png')}}'">
                          @endforeach
                        </div><br>
