  ...
  <body>
      ...
      <div class="column is-6 is-offset-3">
        ...
        <div class="box">
          ...
          @if (isset($envFilExists)&&$envFilExists)
              <div class='notification is-danger' style='padding:12px;'><i class='fa fa-times'></i> Env File not existing! Check Documentation to correct this issue</div>              
          @endif

          @if(phpversion() >= "7.3.0" || extension_loaded('mysqli')||!isset($envFilExists))
